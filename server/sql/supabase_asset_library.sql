-- Legacy copy of migration SQL.
-- Canonical file: supabase/migrations/202603040001_create_app_asset_libraries.sql
-- Run this only if you are not using migration tooling.
